...
public class Modifier {
  ...
  public Integer keepHighest; // null if not set
  ...
  public Integer keepLowest;  // null if not set
 ...
 /** If true, rerolls dice with a value of "1" exactly one time. */
   ...
   */
  public static Modifier none(){ return new Modifier(); }
}

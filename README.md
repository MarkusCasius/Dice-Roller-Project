...
A powerful, high-performance Android application built with Kotlin for tabletop gamers and statisticians. This app features a deterministic 3D-simulated dice tray, custom die creation, complex rule architecture, and a statistical simulator to analyze roll distributions.
...
*   **Cloud Sync:** Connect with Firebase Data Connect (Postgres) to sync your custom dice and rules across devices.
...
3.  **Firebase CLI** (optional, but recommended for Data Connect deployment).
